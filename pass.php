 ...
 $conn = mysqli_connect("localhost", "root", "", "login");
  ...
  if ($result->num_rows > 0) {
   ...
   while($row = $result->fetch_assoc()) {
    echo "<table><tr><td>ID no</td><td>" . $row["id"]. "</td></tr><tr><td>Name</td><td>" . $row["name"]. "</td></tr><tr><td>Father name</td><td>" . $row["father_name"] . "</td></tr><tr><td>Department</td><td>"
